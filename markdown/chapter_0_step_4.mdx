...
Encountering errors during a quest selection, such as choosing a quest that does not exists, is one of many scenarios that need proper handling in your cartesi dApp. This chapter will guide you through create reports to handle errors. By the end of this chapter, your dApp will be equipped to handle incorrect inputs and notify the user appropriately, improving user experience and application reliability.
